...
class UpdateCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'background_image' => 'required_if:background_type,image|image|mimes:jpeg,png,jpg,webp|max:10240',
            'status' => ['nullable', new Enum(CategoryStatusEnum::class)],
            'requires_approval' => 'boolean',
            'is_tabular' => 'boolean',
            'tabular_subtitle' => 'nullable|string|max:255',
            'tabular_subtitle_color' => 'nullable|string|regex:/^#[0-9A-Fa-f]{6}$/',
            'tabular_header_image' => 'nullable|image|mimes:jpeg,png,jpg,webp|max:10240',

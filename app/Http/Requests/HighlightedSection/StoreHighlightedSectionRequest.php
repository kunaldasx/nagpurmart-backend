...
class StoreHighlightedSectionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'badge_text_color' => 'nullable|string|max:30',
            'deal_badge_color' => 'nullable|string|max:30',
            'deal_price_color' => 'nullable|string|max:30',
            ...
            'remove_background_images' => 'nullable|boolean',
            'remove_hero_image' => 'nullable|boolean',
            'remove_powered_by_image' => 'nullable|boolean',

...
class UpdateSellerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'business_license' => 'sometimes|image|mimes:jpeg,png,jpg,webp|max:10240',
            'articles_of_incorporation' => 'sometimes|image|mimes:jpeg,png,jpg,webp|max:10240',
            'national_identity_card' => 'sometimes|image|mimes:jpeg,png,jpg,webp|max:10240',
            'authorized_signature' => 'sometimes|image|mimes:jpeg,png,jpg,webp|max:10240',

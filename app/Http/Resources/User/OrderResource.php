...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'delivery_boy_phone' => $this->deliveryBoy?->user?->mobile ?? "",
            'delivery_boy_profile' => $this->deliveryBoy?->user?->profile_image ?? "",
            'delivery_boy' => $this->delivery_boy_id ? [
                'id' => $this->delivery_boy_id,
                'name' => $this->deliveryBoy?->full_name ?? "",
                'phone' => $this->deliveryBoy?->user?->mobile ?? "",
                'profile_image' => $this->deliveryBoy?->user?->profile_image ?? "",
                'vehicle_type' => $this->deliveryBoy?->vehicle_type ?? "",
                'vehicle_registration' => $this->deliveryBoy?->vehicle_registration ?? "",
            ] : null,

document.addEventListener("DOMContentLoaded", () => {
    $(function () {
        ...
        const serviceAccountInput = document.querySelector(
        ...
        function initializeFilePond(
            ...
            const input =
                document.querySelector(`[name="${inputName}"][type="file"]`) ||
        ...
        (function () {
            ...
            if (csvInput) {
                FilePond.create(csvInput, {
                    ...
                    labelIdle:
                        csvInput.getAttribute("data-label-idle") ||
                        'Drag & Drop your CSV or <span class="filepond--label-action">Browse</span>',
                });
            }
        })();

        initializeFilePond("backgroundImage", [
            "image/jpeg",
            "image/png",
            "image/jpg",
            "image/webp",
        ...
        initializeFilePond("scroll_icon");
        initializeFilePond("scroll_active_icon");
        initializeFilePond("scroll_background", [
            "image/jpeg",
            "image/png",
            "image/jpg",
            "image/webp",

                ...
                <form class="form-submit" method="POST" action="{{ route('admin.highlighted-sections.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3"><label class="form-label">Button color</label><input type="color" class="form-control form-control-color w-100" name="button_color" value="#000000"></div>
                            <div class="col-md-3 mb-3"><label class="form-label">Button text color</label><input type="color" class="form-control form-control-color w-100" name="button_text_color" value="#ffffff"></div>
                            <div class="col-md-3 mb-3"><label class="form-label">Badge color</label><input type="color" class="form-control form-control-color w-100" name="badge_color" value="#000000"></div>
                            <div class="col-md-3 mb-3"><label class="form-label">Badge text color</label><input type="color" class="form-control form-control-color w-100" name="badge_text_color" value="#ffffff"></div>
                            <div class="col-md-3 mb-3"><label class="form-label">Deal badge color</label><input type="color" class="form-control form-control-color w-100" name="deal_badge_color" value="#000000"></div>
                            <div class="col-md-3 mb-3"><label class="form-label">Deal price color</label><input type="color" class="form-control form-control-color w-100" name="deal_price_color" value="#000000"></div>
                            ...
                            <div class="col-12 mb-3"><label class="form-label">Background images</label><input type="file" name="background_images[]" multiple class="form-control filepond" accept="image/*" data-max-files="10" data-images="[]"><div id="highlighted-background-previews" class="d-flex flex-wrap gap-2 mt-2"></div></div>
                            <div class="col-md-6 mb-3"><label class="form-label">Hero image</label><input type="file" name="hero_image" class="form-control filepond" accept="image/*"><img id="highlighted-hero-preview" class="mt-2 rounded border" alt="Hero image preview" style="display:none;max-width:100%;height:120px;object-fit:contain"></div>
                            <div class="col-md-6 mb-3"><label class="form-label">Powered by image</label><input type="file" name="powered_by_image" class="form-control filepond" accept="image/*"><img id="highlighted-powered-by-preview" class="mt-2 rounded border" alt="Powered by image preview" style="display:none;max-width:100%;height:120px;object-fit:contain"></div>
                        </div>

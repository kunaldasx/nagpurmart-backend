            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div class="text-secondary mb-3">
                        Are you sure you want to cancel this order? All items will be cancelled.
                    </div>
                    <div>
                        <textarea
                            id="cancellationNote"
                ...
                <div class="modal-footer">
                    <div class="w-100">
                        <div class="row">
                            <div class="col">
                                <a href="#" class="btn w-100" data-bs-dismiss="modal">Keep Order</a>
                            </div>
                            <div class="col">
                                <a href="#" class="btn btn-danger w-100" id="confirmCancelOrder" data-bs-dismiss="modal">Cancel Order</a>
                            </div>
                        </div>
                    </div>
                </div>

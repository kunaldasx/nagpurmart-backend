                ...
                <div class="card-body">
                    @forelse($lists as $list)
                        <div class="border rounded p-3 mb-3">
                            ...
                            <div class="text-secondary mt-2">Language: {{ $list->language ?: 'unknown' }}</div>
                            ...
                            <div class="table-responsive mt-3">
                                <table class="table table-sm">
                                    <thead><tr><th>Item</th><th>Quantity</th><th>Matched product</th><th>Confidence</th></tr></thead>
                                    <tbody>
                                    ...
                                    @empty
                                        <tr><td colspan="4" class="text-secondary">No items extracted.</td></tr>
                                    @endforelse
                                    </tbody>
                                </table>
                            </div>

...
@section('admin-content')
    ...
    <div class="modal modal-blur fade" id="deleteBroadcastModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <p class="mb-0">Are you sure you want to delete this notification campaign? This action cannot be undone.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-danger" id="confirmDeleteBroadcast">Delete campaign</button>
                </div>
            </div>
        </div>
    </div>
...
@push('script')
    <script src="{{ asset('assets/js/notification.js') }}?v={{ filemtime(public_path('assets/js/notification.js')) }}"></script>
@endpush

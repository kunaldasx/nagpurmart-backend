                                ...
                                <div class="datagrid">
                                    ...
                                    <div class="datagrid-item">
                                        ...
                                        <div class="datagrid-content">
                                            <form method="POST" action="{{ route('admin.products.gift-settings', ['id' => $product->id]) }}" class="d-flex align-items-center gap-2">
                                                @csrf
                                            ...
                                            <small class="text-muted">Threshold is configured globally in Admin Settings.</small>
                                        </div>
                                    </div>
                                    <div class="datagrid-item">
